            ...
            <div class="card-body">
                ...
                <form method="GET" action="{{route('appointments.branchoffice')}}">
                    <div class="form-row">
                        <div class="form-group {{$errors->has('companyId') ? 'alert alert-danger':''}}">
                                ...
                                <option selected disabled readonly>seleccione una compañia...</option>
                ...
                <div class="form-row">
                    <div class="form-group {{$errors->has('branchofficeId') ? 'alert alert-danger':''}}">
                            ...
                            <select id="branchofficeId" class="form-control width-select" placeholder="Sucursal" name="branchofficeId">
