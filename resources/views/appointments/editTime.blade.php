    ...
    <div class="row justify-content-center">
        <div class="card w-75">
            <div class="card-body">
                ...
                <br>
                <form method="GET" action="{{route('appointments.branchoffice.Time')}}">
                    <div class="form-row">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6 {{$errors->has('branchofficeId') ? 'alert alert-danger':''}}">
                                ...
                                <option value="{{$branchofficeQuery->id}}" selected readonly>{{$branchofficeQuery->address}}</option>
                    ...
                    <div class="form-row">
                        <div class="form-group {{$errors->has('date') ? 'alert alert-danger':''}}">
                            ...
                            <input id="date" type="date" name="date" class="form-control" onChange="this.form.submit()" value="<?php date_default_timezone_set('America/Merida');echo date('Y-m-d'); ?>" min="<?php date_default_timezone_set('America/Merida');echo date('Y-m-d'); ?>" step="1" require>
