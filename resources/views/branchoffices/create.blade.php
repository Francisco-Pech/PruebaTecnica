    ...
    <div class="row justify-content-center">
        <div class="card w-75">
            <div class="card-body">
                ...
                <br>
                <form method="POST" action="{{route('branchoffices.store')}}">
                    {{-- {{csrf_field()}} --}}
                    @csrf
                    <div class="form-row">
                    ...
                    <div class="form-row">
                        <div  class="form-group col-md-6 {{$errors->has('startTime') ? 'alert alert-danger':''}}">
                            ...
                            <input id="startTime" type="time" name="startTime" class="form-control" value="{{old('startTime')}}" require>
                        ...
                        <div  class="form-group col-md-6 {{$errors->has('endTime') ? 'alert alert-danger':''}}">
                            ...
                            <input id="endTime" type="time" name="endTime" class="form-control" value="{{old('endTime')}}" require>
