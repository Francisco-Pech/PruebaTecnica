    ...
    <div class="row justify-content-center">
        <div class="card w-75">
            <div class="card-body">
                ...
                <br>
                <h5><b>Usuarios</b></h5>
                <form method="POST" action="{{route('users.supervisor.store')}}">
                    {{-- {{csrf_field()}} --}}
                    @csrf
                    <div class="form-row">
                        ...
                        <div class="form-group {{$errors->has('branchofficeId') ? 'alert alert-danger':''}}">
                            <label style="margin-left:0.3rem;">Sucursal</label>
                            <select id="branchofficeId" class="form-control width-select" style="margin-left:0.35rem;" placeholder="Sucursal" name="branchofficeId" require>
